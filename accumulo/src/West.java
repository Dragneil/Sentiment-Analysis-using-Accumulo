 ...
 */
public class West extends Configured {
  /**
   * The Mapper class that given a row number, will generate the appropriate output line.
   */
  public static class WestMapper extends Mapper<Key,Value,Text,Text> {
  ...
  public static class WestReduce extends Reducer<Text, Text, Text, Text> {
	  ...
	  Map<String, String> WestTeam = new HashMap(){
	  {
		put("okcthunder","Oklahoma City");
		put("Nuggets","Denver Nuggets");
		put("TrailBlazers","Portland Trailblazers");
		put("UtahJazz","Utah Jazz");
		put("TWolves","Minnesota Timberwolves");
	    put("Lakers","LA Lakers");
	    put("Suns","Phoenix Suns");
	    put("GSWarriors","Golden State Warriors");
	    put("Clippers","L.A.Clippers");
	    put("NBAKings","Sacramento Kings");
	    put("GoSpursGo","San Antonio Spurs");
	    put("Mavs","Dallas Mavericks");
	    put("Hornets","New Orleans Hornets");
	    put("Grizzlies","Memphis Grizzlies");
	    put("Rockets","Houston Rockets");
	    }};
	  ...
	  for(String x : sortedmap.keySet()){
		  ...
		  finallist = finallist +WestTeam.get(x)+ "," +x + ","+ sortedmap.get(x).toString()+ "\n";
	  }
	  key.set(" ");
	  value.set(finallist);
	  context.write(key,value);
